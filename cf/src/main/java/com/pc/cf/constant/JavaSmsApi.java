...
public class JavaSmsApi {
    ...
    //查账户信息的http地址
    public static String URI_GET_USER_INFO = "https://sms.yunpian.com/v2/user/get.json";
    ...
    //发送语音验证码接口的http地址
    public static String URI_SEND_VOICE = "https://voice.yunpian.com/v2/voice/send.json";
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        ...
        String mobile = null;
        try {
            mobile = URLEncoder.encode("13886027496", JavaSmsApi.ENCODING);
        ...
        try {
            tpl_value = URLEncoder.encode("#code#", JavaSmsApi.ENCODING) +"="
                    + URLEncoder.encode("1234", JavaSmsApi.ENCODING);
//					+ "&"
//                    + URLEncoder.encode("#company#",JavaSmsApi.ENCODING) + "="
//                    + URLEncoder.encode("云片网",JavaSmsApi.ENCODING);
